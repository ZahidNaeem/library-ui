...
import {
  API_BOOK_TRANS_HEADER_ISSUANCE_URL,
  API_BOOK_URL,
  API_READER_URL,
  BUTTON_ADD,
  BUTTON_DELETE,
...
class BookTransHeaderIssue extends Component {
  ...
  saveBookTransHeader = async () => {
    ...
    if (this.validateForm() === false) {
      ...
      const options = {
        url: API_BOOK_TRANS_HEADER_ISSUANCE_URL,
        method: 'POST',
  ...
  deleteBookTransHeader = async () => {
    ...
    if (bookTransHeader.headerId !== undefined && bookTransHeader.headerId
      ...
      const options = {
        url: API_BOOK_TRANS_HEADER_ISSUANCE_URL + bookTransHeader.headerId,
        method: 'DELETE'
      };
      try {
        const res = await request(options);
  ...
  navigateBookTransHeader = async (operation) => {
    const options = {
      url: API_BOOK_TRANS_HEADER_ISSUANCE_URL + operation,
      method: 'GET'
    };
    try {
      const res = await request(options);
